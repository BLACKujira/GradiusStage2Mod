...
AL088::AL088(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AL088::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
