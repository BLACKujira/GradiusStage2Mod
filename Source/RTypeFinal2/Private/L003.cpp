...
AL003::AL003(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AL003::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
