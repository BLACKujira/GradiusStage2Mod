...
AEL003::AEL003(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AEL003::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
