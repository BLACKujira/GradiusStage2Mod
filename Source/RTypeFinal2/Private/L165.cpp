...
AL165::AL165(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AL165::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
