...
AL065::AL065(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AL065::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
