...
AL033Sub::AL033Sub(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AL033Sub::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
