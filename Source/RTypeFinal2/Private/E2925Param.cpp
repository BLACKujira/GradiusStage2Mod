#include "E2925Param.h"

UE2925Param::UE2925Param() {
    this->Defence = 0;
    this->Score = 100;
    this->BodyMesh = NULL;
    this->AnimBP = NULL;
    ...
    this->BrokenMesh7 = NULL;
    this->BrokenMesh8 = NULL;
    this->ChargeEffect = NULL;
    this->ShotEffect = NULL;
    this->ToothNum = 8;
    this->Radius = 500.00f;
    this->CollisionARadiusOffset = 0.00f;
    this->CollisionBRadiusOffset = 0.00f;
    this->CollisionCRadiusOffset = 0.00f;
