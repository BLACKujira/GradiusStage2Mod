...
AL188::AL188(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void AL188::OnOverlapEnemyBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult) {
}
