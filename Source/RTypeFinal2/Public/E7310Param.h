...
#include "E7310Param.generated.h"
...
class UE7310Param : public UEnemyParam {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FEnemyDifficultyFloat SearchSpeed;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FEnemyDifficultyFloat InitRotateSpeed;
