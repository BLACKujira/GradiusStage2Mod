...
#include "E7345Missile.generated.h"
...
class AE7345Missile : public AEnemyActor {
    GENERATED_BODY()
public:
...
private:
    ...
    UNiagaraComponent* EffMove;
    
public:
    AE7345Missile(const FObjectInitializer& ObjectInitializer);
