...
#include "BS029DecelerationBullet.generated.h"
...
class ABS029DecelerationBullet : public AEnemyActor {
    GENERATED_BODY()
public:
...
private:
    ...
    UAudioComponent* AudioComponentHit;
    
public:
    ABS029DecelerationBullet(const FObjectInitializer& ObjectInitializer);
