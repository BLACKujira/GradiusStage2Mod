...
#include "AnimationBudgetAllocatorParameters_Clone.generated.h"

USTRUCT(BlueprintType)
struct FAnimationBudgetAllocatorParameters_Clone {
    GENERATED_BODY()
public:
    ...
    RTYPEFINAL2_API FAnimationBudgetAllocatorParameters_Clone();
};
