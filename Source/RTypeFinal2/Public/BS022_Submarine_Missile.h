...
#include "BS022_Submarine_Missile.generated.h"

class AActor;
class UPrimitiveComponent;

UCLASS(Blueprintable)
class ABS022_Submarine_Missile : public AEnemyActor {
    GENERATED_BODY()
public:
private:
...
public:
    ABS022_Submarine_Missile(const FObjectInitializer& ObjectInitializer);
