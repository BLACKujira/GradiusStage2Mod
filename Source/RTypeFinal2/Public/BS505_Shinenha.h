...
#include "BS505_Shinenha.generated.h"

class AActor;
class ABS505_Shinenha;
class UEnemyPathDataAsset;
class UPrimitiveComponent;

UCLASS(Blueprintable)
class ABS505_Shinenha : public AEnemyActor {
    GENERATED_BODY()
public:
private:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<ABS505_Shinenha*> ChildArray;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UEnemyPathDataAsset* PathData;
    
public:
    ABS505_Shinenha(const FObjectInitializer& ObjectInitializer);
